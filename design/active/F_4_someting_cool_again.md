...
agents:
  ...
  - design/logs/conversation__card__active_f_4_someting_cool_again__agent_16717b5e_4d2e_4626_95bd_aa7cfb4a1580.json
policy:
after: 
---
...
Show Observation augmentation restrictions in the image/video info overlay and tooltip, with an independent visibility toggle. Extract the `Info shown` submenu from `search_result_item_menu.jsx` into its own component.
